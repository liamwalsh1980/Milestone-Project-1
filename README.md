...
#### Please click <a href="https://github.com/liamwalsh1980/Milestone-Project-1/tree/master/assets/readme/ux/wireframes" target="_blank">PDF Wireframes </a> to see all versions 
...
* There was an ordered list using numbers 1-3 giving an easy step by step process to move throughout the website. However, after careful consideration I decided to remove the ordered list and strengthen the look of the navigation menu bar with easy-to-understand menu titles within the navigation bar. Early versions of my <a href="https://github.com/liamwalsh1980/Milestone-Project-1/tree/master/assets/readme/ux/wireframes" target="_blank">embrace-autism-wireframes-1.pdf</a> shows this feature.  
