...
Essentially, this part is your sales pitch. [delete]
...
1. The design I wanted to achieve was a clean and friendly website for people to visit and return back to as more ideas are added. Therefore, I feel the colour schemes and font choices were going to be an important part of the design process. I took my time testing different font styles on Google Fonts and chose the Ubuntu font for most of the content and the Kalam font for the logo text and home page subheader benefits list. The home and subscribe pages would have minimum content. The home page would be designed to gain the users attention and encourage them to easily navigate to the about page and then onto the subscribe page to complete the form to sign up to receive on-going information and advice which would be sent by email each week or month. I changed the colour of the website a couple of times and used coolors.co site to assist with a couple of colours that worked well to compliment my preferred blue (hex: 479ce0). The coolors.co colours chosen are - dark blue (hex:274c77) and light grey (hex:e7ecef).

1. All three pages have the same header and footer formated. The header has the Autism logo ribbon in full rainbow colour with the text logo 'Embrace Autism' in dark blue next to the logo at the top left. When hovering over the logo text the dark blue colour (hex:274c77) becomes light blue (hex:479ce0) as its a link to the homepage and therefore by clicking on the logo text will always bring you back to the homepage (index.html). On the right side of the header there is a navigtion bar for the home page, about page and subscribe page. The default colour for all three page titles is light blue (hex:479ce0) and when hovering over one of the page titles links the colour will turn from light blue (hex:479ce0) to dark blue (hex:274c77). The relelvant page title in the navigation menu will be automatically dark blue (hex:274c77) and underlined in the same colour to show which page you are currently on. 

1. The home page design went through a few trial and error stages with the positioning of the heroimage and lists on the right side. I wanted to use all three colours to maximise the attraction of this page. The first list is unordered and highlights the main services the website offers. The second list is ordered using numbers 1-3 giving an easy step by step process to get the most from the site. However, after careful consideration i decided to remove the ordered list and strenghen the look of the navigation menu bar. Below the lists there is a 'SUBSCRIBE FOR FREE' button which is linked to the subscribe page. This button is dark blue (hex:274c77) with the text in light grey (hex:e7ecef). The wording is in capital letters and when hovering over this button the colour of the button changes to light blue (hex:479ce0). After removing the ordered list i had the option to increase the size of this 'SUBSCRIBE FOR FREE' to encourage users to subscribe easily. 
